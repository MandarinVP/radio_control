...
SERVER_IP_FILE = "/home/pi/radio_control/client_ip.cfg"
...
def index():
    ...
    if request.method == "POST":
        ...
        if action == "set_speaker":
            ...
            os.system("/usr/sbin/alsactl -f /var/lib/alsa/asound.state store")
        elif action == "set_mic":
...
def config_editor():
    ...
    if request.method == "POST":
        ...
        if action == "save_server":
            ...
            os.system("sudo /home/pi/radio_control/restart_services_on_server.sh")
